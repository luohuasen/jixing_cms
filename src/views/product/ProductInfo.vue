    ...
    <section>
        ...
        <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false" :fullscreen="true">
            <el-form :model="editForm" label-width="80px" ref="editForm">
                <el-form-item label="标题" prop="productTitle">
                    <el-input v-model="editForm.productTitle" auto-complete="off"></el-input>
                </el-form-item>
        ...
        <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false" :fullscreen="true">
            <el-form :model="addForm" label-width="80px" ref="addForm">
                <el-form-item label="标题" prop="productTitle">
                    <el-input v-model="addForm.productTitle" auto-complete="off"></el-input>
                </el-form-item>
...
<script>
    ...
    import { getProductInfoListPage, updateProductInfo, addProductInfo, deleteProductInfo } from '../../api/api';
    ...
    export default {
        ...
        methods: {
            ...
            list() {
                ...
                getProductInfoListPage(para).then((res) => {
            ...
            handleDel: function (index, row) {
                this.$confirm('确认删除该记录吗?', '提示', {
                    ...
                    this.listLoading = true;
                    let para = { id: row.id };
                    deleteProductInfo(para).then((res) => {
                        this.listLoading = false;
                        this.$message({
                            message: '删除成功',
                            type: 'success'
                ...
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            updateProductInfo(para).then((res) => {
